    ...
    <div class="container">
      <div class="row">
        <div class="col-sm text-center">
          ...
          <br><br>
          <p class="text-center" style="font-size: 2rem;">Approved Enclave Budget 2018</p>
          <br>
          <a class="btn btn-dark btn-lg" role="button" href="documents/<?php echo $_COOKIE['imageDirectoryName']; ?>/approvedCrestview2018Budget.pdf" download="approvedCrestview2018Budget.pdf" style="background-color: #183b64 !important;">Download</a>
        </div>
        <div class="col-sm text-center">
          <span><i class="far fa-file-alt fa-7x" style="color: #183b64 !important;"></i></span>
          <br><br>
          <p class="text-center" style="font-size: 2rem;">Enclave Condo Documents</p>
          <br>
          <a class="btn btn-dark btn-lg" role="button" href="documents/<?php echo $_COOKIE['imageDirectoryName']; ?>/enclaveCondoDocs1.pdf" download="enclaveCondoDocs1.pdf" style="background-color: #183b64 !important; border-outline: none;">Download</a>
        </div>
        <div class="col-sm text-center">
          <span><i class="far fa-file-alt fa-7x" style="color: #183b64 !important;"></i></span>
          <br><br>
