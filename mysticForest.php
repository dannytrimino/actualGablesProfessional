  ...
  <div class="container">
    <div class="row">
      <div class="col-sm text-center">
        <p class="text-center">There are no annoucments at this time</p>
      </div>
...
Architectual Request
          ...
          <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
            <a class="dropdown-item" href="documents/<?php echo $_COOKIE['imageDirectoryName']; ?>/aRequest.pdf" download="requestForm.pdf">Architectural Request Form</a>
            <a class="dropdown-item" href="documents/<?php echo $_COOKIE['imageDirectoryName']; ?>/doorKnobsApproved.jpg">Approved Door Knobs</a>
            </div>
        </div></div>
    </div>
    ...
    <div class="col-sm-4 text-center">
        <span><i class="far fa-file-alt fa-7x" style="color: #183b64 !important;"></i></span>
        <br><br>
        <p class="text-center" style="font-size: 1.2rem;">HOA Application for Acknowledgement</p>
        <br>
        <a class="btn btn-dark btn-lg" role="button" href="documents/<?php echo $_COOKIE['imageDirectoryName']; ?>/acknowledgement.pdf" download="acknowledgement.pdf" style="background-color: #183b64 !important; border-outline: none;">Download</a>
      </div>
      <div class="col-sm-4 text-center">
        <span><i class="far fa-file-alt fa-7x" style="color: #183b64 !important;"></i></span>
        <br><br>
        <p class="text-center" style="font-size: 1.2rem;">Homeowner Contact</p>
        <br>
        <a class="btn btn-dark btn-lg" role="button" href="documents/<?php echo $_COOKIE['imageDirectoryName']; ?>/homeownerContact.pdf" download="homeownerContact.pdf" style="background-color: #183b64 !important; border-outline: none;">Download</a>
      </div>
    </div>
  </div>
  <br><br>
