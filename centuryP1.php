    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-sm text-center">
          <span><i class="far fa-file-alt fa-7x" style="color: #183b64 !important;"></i></span>
          <br><br>
          <p class="text-center" style="font-size: 2rem;">Century Parc 1 Doc</p>
          <br>
          <a class="btn btn-dark btn-lg" role="button" href="documents/<?php echo $_COOKIE['imageDirectoryName']; ?>/centuryPark1Doc.pdf" download="centuryPark1Doc.pdf" style="background-color: #183b64 !important; border-outline: none;">Download</a>
        </div>
        <div class="col-sm text-center">
          <span><i class="far fa-file-alt fa-7x" style="color: #183b64 !important;"></i></span>
          <br><br>
