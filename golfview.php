  ...
  <div class="container">
    <div class="row">
      <div class="col-sm text-center">
        ...
        <br>
        <a class="btn btn-dark btn-lg" role="button" href="documents/<?php echo $_COOKIE['imageDirectoryName']; ?>/golfviewCondoDocs.pdf" download="golfviewCondoDocs.pdf" style="background-color: #183b64 !important;">Download</a>
      </div>
      <div class="col-sm text-center">
        <span><i class="far fa-file-alt fa-7x" style="color: #183b64 !important;"></i></span>
        <br><br>
        ...
        <br>
        <a class="btn btn-dark btn-lg" role="button" href="documents/<?php echo $_COOKIE['imageDirectoryName']; ?>/golfviewBudget2018Approved.pdf" download="golfviewBudget2018Approved.pdf" style="background-color: #183b64 !important; border-outline: none;">Download</a>
      </div>
    </div>
  </div>
  <br><br>
