    ...
    <div class="container">
      <div class="row">
        <div class="col-sm text-center">
          ...
          <br><br>
          <p class="text-center" style="font-size: 2rem;">Approved Budget 2018 No Chart No Reserve</p>
          <br>
          <a class="btn btn-dark btn-lg" role="button" href="documents/<?php echo $_COOKIE['imageDirectoryName']; ?>/approvedBudget2018NoChartNoReserve.pdf" download="approvedBudget2018NoChartNoReserve.pdf" style="background-color: #183b64 !important;">Download</a>
        </div>
        <div class="col-sm text-center">
          <span><i class="far fa-file-alt fa-7x" style="color: #183b64 !important;"></i></span>
          <br><br>
          <p class="text-center" style="font-size: 2rem;">International Park I Condominium Association</p>
          <br>
          <a class="btn btn-dark btn-lg" role="button" href="documents/<?php echo $_COOKIE['imageDirectoryName']; ?>/internationalParkICondominiumAssociation.pdf" download="internationalParkICondominiumAssociation.pdf" style="background-color: #183b64 !important; border-outline: none;">Download</a>
        </div>
      </div>
    </div>
    <br><br>
