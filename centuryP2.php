    ...
    <div class="container">
      <div class="row">
        <div class="col-sm text-center">
          ...
          <br><br>
          <p class="text-center" style="font-size: 2rem;">Century Parc 2 Doc</p>
          <br>
          <a class="btn btn-dark btn-lg" role="button" href="documents/<?php echo $_COOKIE['imageDirectoryName']; ?>/centuryPark2Doc.pdf" download="centuryPark2Doc.pdf" style="background-color: #183b64 !important;">Download</a>
        </div>
        <div class="col-sm text-center">
          <span><i class="far fa-file-alt fa-7x" style="color: #183b64 !important;"></i></span>
          <br><br>
