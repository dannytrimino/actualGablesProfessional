...
<div class="container">
      <div class="row">
        <div class="col-sm text-center">
          ...
          <br><br>
          <p class="text-center" style="font-size: 2rem;">Century Park West Recorded Clubhouse Declaration</p>
          <br>
          <a class="btn btn-dark btn-lg" role="button" href="documents/<?php echo $_COOKIE['imageDirectoryName']; ?>/CPWRecordedClubhouseDeclaration.pdf" download="CPWRecordedClubhouseDeclaration.pdf" style="background-color: #183b64 !important;">Download</a>
        </div>
        <div class="col-sm text-center">
          <span><i class="far fa-file-alt fa-7x" style="color: #183b64 !important;"></i></span>
          <br><br>
          <p class="text-center" style="font-size: 2rem;">Century Park West Recorded Condominum Documents</p>
          <br>
          <a class="btn btn-dark btn-lg" role="button" href="documents/<?php echo $_COOKIE['imageDirectoryName']; ?>/CPWRecordedCondominumDocuments.pdf" download="CPWRecordedCondominumDocuments.pdf" style="background-color: #183b64 !important; border-outline: none;">Download</a>
        </div>
        <div class="col-sm text-center">
          <span><i class="far fa-file-alt fa-8x" style="color: #183b64 !important;"></i></span>
          <br><br>
          <p class="text-center" style="font-size: 2rem;">First Amendment To Declaration</p>
          <br>
          <a class="btn btn-dark btn-lg" role="button" href="documents/<?php echo $_COOKIE['imageDirectoryName']; ?>/firstAmendmentToDeclaration.pdf" download="firstAmendmentToDeclaration.pdf" style="background-color: #183b64 !important;">Download</a>
        </div>
        <div class="col-sm text-center">
          <span><i class="far fa-file-alt fa-7x" style="color: #183b64 !important;"></i></span>
          <br><br>
