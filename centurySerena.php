...
<body>
  ...
  <span class="navbar-toggler-icon"></span>
    ...
    <div class="collapse navbar-collapse" id="navbarsExampleDefault">
      ...
      <ul class="navbar-nav ml-auto">
<li class="nav-item active">
<a class="nav-link" href="http://www.clickpay.com/gables"><button type="button" class="btn btn-outline-warning">Make A Payment</button><span class="sr-only">(current)</span></a>
</li>
</ul>
  ...
  <div class="container">
    <div class="row">
      <div class="col text-center">
        ...
        <br><br>
        <p class="text-center" style="font-size: 1rem;">Documents</p>
        <br>
      ...
      <div class="col text-center">
        <span><i class="far fa-file-alt fa-7x" style="color: #183b64 !important;"></i></span>
        <br><br>
        <p class="text-center" style="font-size: 1rem;">Governing Documents</p>
        <br>
        <a class="btn btn-dark btn-lg" role="button" href="documents/<?php echo $_COOKIE['imageDirectoryName']; ?>/gDocuments.pdf" download="gDocuments.pdf" style="background-color: #183b64 !important;">Download</a>
      </div>
      <div class="col text-center">
        <span><i class="far fa-file-alt fa-7x" style="color: #183b64 !important;"></i></span>
        <br><br>
        <p class="text-center" style="font-size: 1rem;">Approved Budget</p>
        <br>
      ...
      <div class="col text-center">
        <span><i class="far fa-file-alt fa-7x" style="color: #183b64 !important;"></i></span>
        <br><br>
        <p class="text-center" style="font-size: 1rem;">Home Owner Contact Information</p>
        <br>
