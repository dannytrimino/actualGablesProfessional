  ...
  <div class="container">
    <div class="row">
      <div class="col text-center">
        ...
        <br>
        <a class="btn btn-dark btn-lg" role="button" href="documents/<?php echo $_COOKIE['imageDirectoryName']; ?>/documents.pdf" download="declaration.pdf" style="background-color: #183b64 !important;">Download</a>
      </div>
      <div class="col text-center">
        <span><i class="far fa-file-alt fa-7x" style="color: #183b64 !important;"></i></span>
        <br><br>
...
<div class="container">
    <div class="row">
      <div class="col text-center">
        <span><i class="far fa-file-alt fa-7x" style="color: #183b64 !important;"></i></span>
        <br><br>
        <p class="text-center" style="font-size: 2rem;">Amended Declaration</p>
        <br>
        <a class="btn btn-dark btn-lg" role="button" href="documents/<?php echo $_COOKIE['imageDirectoryName']; ?>/amendDeclaration.pdf" download="amendDeclaration.pdf" style="background-color: #183b64 !important;">Download</a>
      </div>
      <div class="col text-center">
        <span><i class="far fa-file-alt fa-7x" style="color: #183b64 !important;"></i></span>
        <br><br>
        <p class="text-center" style="font-size: 2rem;">The Sanderling</p>
        <br>
        <a class="btn btn-dark btn-lg" role="button" href="documents/<?php echo $_COOKIE['imageDirectoryName']; ?>/theSanderling.pdf" download="theSanderling.pdf" style="background-color: #183b64 !important; border-outline: none;">Download</a>
      </div>
    </div>
  </div>  
  <br><br>
